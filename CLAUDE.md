# CLAUDE.md — cloudsmith-core

Claude Code context for `cloudsmith-core` — one of the code repos in the CloudSmith open-source project.

## What this repo is

MLM runtime, RBAC engine, audit log, org/tenant management, notification hub, and runner registry
...
- `cloudsmith-core-engineer` (model: sonnet) — cloudsmith-core application engineer — TypeScript, Node.js, API development, tests
